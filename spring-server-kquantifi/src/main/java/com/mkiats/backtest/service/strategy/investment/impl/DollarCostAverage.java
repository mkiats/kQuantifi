...
public class DollarCostAverage implements InvestmentStrategy {
	...
	public InvestmentOutput executeStrategy(
		...
		//			LocalDateTime localDateTimeKey = DateUtils.convertStringToLocalDate(
		//				dateKey,
		//				"yyyy-MM-dd"
		//			).atStartOfDay();
		//			if (
		//				localDateTimeKey.isAfter(
		//					DateUtils.convertStringToLocalDateTime(
		//						thePortfolio.getStartDate(),
		//						"EEE MMM dd yyyy HH:mm:ss 'GMT'Z (zzzz)"
		//					)
		//				) &&
		//				localDateTimeKey.isBefore(
		//					DateUtils.convertStringToLocalDateTime(
		//						thePortfolio.getEndDate(),
		//						"EEE MMM dd yyyy HH:mm:ss 'GMT'Z (zzzz)"
		//					)
		//				)
		//			) {
		...
		//				);
		//				double dcaQuantity = BigDecimal.valueOf(
		//					periodicAmount / closingPrice
		//				)
