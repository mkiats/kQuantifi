...
public class AlgorithmServiceRegistry {
	...
	private final Map<String, AlgorithmService> algorithmServices =
		new HashMap<>();

	@Autowired
	public AlgorithmServiceRegistry(
		List<AlgorithmService> algorithmServiceList
	) {
		algorithmServiceList.forEach(
			service ->
				algorithmServices.put(
